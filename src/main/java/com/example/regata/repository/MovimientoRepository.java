...
public interface MovimientoRepository extends JpaRepository<Movimiento, UUID> {
    ...
    List<Movimiento> findByParticipacionId(@Param("participacionId") UUID participacionId);
    ...
    Optional<Movimiento> findByParticipacionIdAndTurno(@Param("participacionId") UUID participacionId, 
    ...
    List<Movimiento> findByParticipacionIdAndTurnoBetween(@Param("participacionId") UUID participacionId,
    ...
    List<Movimiento> findMovimientosConColisionByParticipacionId(@Param("participacionId") UUID participacionId);
    
    // Buscar movimientos por posición específica
    @Query("SELECT m FROM Movimiento m WHERE m.participacion.idParticipacion = :participacionId AND " +
           "m.posX = :posX AND m.posY = :posY")
    List<Movimiento> findByParticipacionIdAndPosicion(@Param("participacionId") UUID participacionId,
    ...
    Optional<Movimiento> findUltimoMovimientoByParticipacionId(@Param("participacionId") UUID participacionId);
    ...
    Long countByParticipacionId(@Param("participacionId") UUID participacionId);
    ...
    List<Movimiento> findByParticipacionIdOrderByTurnoAsc(@Param("participacionId") UUID participacionId);
    
    // Buscar movimientos por velocidad específica
    @Query("SELECT m FROM Movimiento m WHERE m.participacion.idParticipacion = :participacionId AND " +
           "m.velX = :velX AND m.velY = :velY")
    List<Movimiento> findByParticipacionIdAndVelocidad(@Param("participacionId") UUID participacionId,
